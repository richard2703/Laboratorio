        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('doctores.update', $doctore->id) }}" method="post" class="form-horizontal">
                        @csrf
                        @method('put')
                        <div class="card-body">
