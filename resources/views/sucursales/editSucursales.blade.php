@extends('layouts.app', ['activePage' => 'lugaresTrabajo', 'activeItem' => 'sucursales'])
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('sucursales.update', $sucursale->id) }}" method="post" class="form-horizontal">
                        @csrf
                        @method('put')
                        <div class="card-body">
